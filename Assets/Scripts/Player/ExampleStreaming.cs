                ...
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        if (alt.transcript.Contains("shoot"))
                        {
                            ...
                            Raycasting.voiceRec = "shoot";
                            PlayerAttack.shoot = "shoot";
                                              }


                        if (alt.transcript.Contains("play"))
                        {
                            //cubeMeshrenderer.material = red_material;
                            MenuMngr.voiceRec = "play";
                        }
                        if (alt.transcript.Contains("nothing"))
                        {
                            //cubeMeshrenderer.material = red_material;
                            Riddle.anw= "nothing";
                        }
                        ...
                        //pause menu menu 
                        if (alt.transcript.Contains("menu"))
                        {
                            PauseMenu.voiceRec = "menu";

                        }

                        if (alt.transcript.Contains("quit"))
                        {
                            PauseMenu.voiceRec = "quit";
                            MenuMngr.voiceRec = "quit";

                        }
                        //pause menu go back from menu
                        if (alt.transcript.Contains("back"))
                        {
                            PauseMenu.voiceRec = "back";
                            Raycasting.voiceRec = "back";

                        }

                        if (alt.transcript.Contains("change"))
                        {
                            cubeMeshrenderer.material = blue_material;
                            Raycasting.voiceRec = "change";
                        }

                        //opening scene
                        if (alt.transcript.Contains("start"))
                        {
                            OpeningCommand.voice = "start";
